...
use OpenOrchestra\Backoffice\Validator\Constraints\BlockNodePatternValidator;
...
class BlockNodePatternValidatorTest extends AbstractBaseTestCase
{
    ...
    {
        $this->constraint = Phake::mock('OpenOrchestra\Backoffice\Validator\Constraints\BlockNodePattern');
