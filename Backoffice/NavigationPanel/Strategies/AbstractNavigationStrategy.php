 ...
 */
abstract class AbstractNavigationStrategy implements NavigationPanelInterface
{
     ...
     */
    public function __construct($name, $weight, $parent, $role = null, array $datatableParameter = array(), $translator = null)
    {
        $this->name = $name;
        $this->role = $role;
        $this->weight = $weight;
