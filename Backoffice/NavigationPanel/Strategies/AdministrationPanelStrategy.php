...
class AdministrationPanelStrategy extends AbstractNavigationPanelStrategy
{
    ...
    const ROLE_ACCESS_CREATE_REDIRECTION = 'ROLE_ACCESS_CREATE_REDIRECTION';
    const ROLE_ACCESS_UPDATE_REDIRECTION = 'ROLE_ACCESS_UPDATE_REDIRECTION';
    const ROLE_ACCESS_DELETE_REDIRECTION = 'ROLE_ACCESS_DELETE_REDIRECTION';
    ...
    const ROLE_ACCESS_CREATE_THEME = 'ROLE_ACCESS_CREATE_THEME';
    const ROLE_ACCESS_UPDATE_THEME = 'ROLE_ACCESS_UPDATE_THEME';
    const ROLE_ACCESS_DELETE_THEME = 'ROLE_ACCESS_DELETE_THEME';
    const ROLE_ACCESS_GROUP = 'ROLE_ACCESS_GROUP';
    const ROLE_ACCESS_CREATE_GROUP = 'ROLE_ACCESS_CREATE_GROUP';
    const ROLE_ACCESS_UPDATE_GROUP = 'ROLE_ACCESS_UPDATE_GROUP';
    const ROLE_ACCESS_DELETE_GROUP = 'ROLE_ACCESS_DELETE_GROUP';
    const ROLE_ACCESS_USER = 'ROLE_ACCESS_USER';
    const ROLE_ACCESS_CREATE_USER = 'ROLE_ACCESS_CREATE_USER';
    const ROLE_ACCESS_UPDATE_USER = 'ROLE_ACCESS_UPDATE_USER';
    const ROLE_ACCESS_DELETE_USER = 'ROLE_ACCESS_DELETE_USER';
