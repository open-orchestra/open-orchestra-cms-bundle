...
class AdministrationPanelStrategy extends AbstractNavigationPanelStrategy
{
    ...
    const ROLE_ACCESS_REMOVED_TRASHCAN = 'ROLE_ACCESS_REMOVED_TRASHCAN';
    const ROLE_ACCESS_STATUS = 'ROLE_ACCESS_STATUS';
    const ROLE_ACCESS_CREATE_STATUS = 'ROLE_ACCESS_CREATE_STATUS';
    const ROLE_ACCESS_UPDATE_STATUS = 'ROLE_ACCESS_UPDATE_STATUS';
    const ROLE_ACCESS_DELETE_STATUS = 'ROLE_ACCESS_DELETE_STATUS';
    ...
    const ROLE_ACCESS_CREATE_ROLE = 'ROLE_ACCESS_CREATE_ROLE';
    const ROLE_ACCESS_UPDATE_ROLE = 'ROLE_ACCESS_UPDATE_ROLE';
    const ROLE_ACCESS_DELETE_ROLE = 'ROLE_ACCESS_DELETE_ROLE';
