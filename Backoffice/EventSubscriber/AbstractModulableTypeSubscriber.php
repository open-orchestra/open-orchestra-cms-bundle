...
@trigger_error('The '.__NAMESPACE__.'\AbstractModulableTypeSubscriber class is deprecated since version 1.2.0 and will be removed in 2.0', E_USER_DEPRECATED);

/**
 * Class AbstractModulableTypeSubscriber
 * @deprecated  deprecated since version 1.2.0 and will be removed in version 2.0
 */
