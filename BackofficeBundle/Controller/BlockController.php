...
class BlockController extends AbstractEditionRoleController
{
     ...
     *
     * @Config\Security("is_granted('ROLE_ACCESS_NODE') or is_granted('ROLE_ACCESS_UPDATE_ERROR_NODE') or is_granted('ROLE_ACCESS_UPDATE_GENERAL_NODE') or is_granted('ROLE_ACCESS_TREE_GENERAL_NODE') or is_granted('ROLE_ACCESS_TREE_NODE') or is_granted('ROLE_ACCESS_ERROR_NODE')")
     *
     * @return Response
     */
