...
class ContentWorkflowVoterTest extends AbstractVoterTest
{
    ...
    protected function getNotSupportedSubjects()
    {
        ...
        return array(
            'Bad subject : Node'             => array($node       , $transition, array(ContributionRoleInterface::DEVELOPER), true, VoterInterface::ACCESS_ABSTAIN),
    ...
    protected function getNotInPerimeter()
    {
        ...
        return array(
            'Not in perimeter : Contributor'         => array($content, $transition, array(ContributionRoleInterface::NODE_CONTRIBUTOR), false, VoterInterface::ACCESS_DENIED, false),
            'Transition does not exist : Developper' => array($content, $transition, array(ContributionRoleInterface::DEVELOPER)       , false, VoterInterface::ACCESS_DENIED, false),
        );
    }
    ...
    protected function getOkVotes()
    {
        ...
        return array(
            'Ok : Contributor' => array($content, $transition, array(ContributionRoleInterface::NODE_CONTRIBUTOR), true , VoterInterface::ACCESS_GRANTED, true),
            'Ok : Developper'  => array($content, $transition, array(ContributionRoleInterface::DEVELOPER)       , false, VoterInterface::ACCESS_GRANTED, true),
        );
    }
}
