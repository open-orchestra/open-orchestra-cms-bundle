...
/**
 * Class AreaNotFoundHttpException
 */
class AreaNotFoundHttpException extends ApiException
{
    const DEVELOPER_MESSAGE  = 'open_orchestra_api.area.not_found';
    const HUMAN_MESSAGE      = 'open_orchestra_api.area.not_found';
