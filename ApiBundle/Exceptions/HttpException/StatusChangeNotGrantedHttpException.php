...
/**
 * Class StatusChangeNotGrantedHttpException
 */
class StatusChangeNotGrantedHttpException extends ApiException
{
    const DEVELOPER_MESSAGE  = 'open_orchestra_api.status.change_not_granted';
    const HUMAN_MESSAGE      = 'open_orchestra_api.status.change_not_granted';
