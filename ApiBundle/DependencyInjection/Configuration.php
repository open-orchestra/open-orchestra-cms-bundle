        ...
        $rootNode->children()
            ->arrayNode('facades')
                ...
                ->children()
                    ...
                    ->scalarNode('model_group_role')->defaultValue('OpenOrchestra\ApiBundle\Facade\ModelGroupRoleFacade')->end()
                    ...
                    ->scalarNode('datatable_collection_parameter')->defaultValue('OpenOrchestra\ApiBundle\Facade\DatatableCollectionParameterFacade')->end()
                    ->scalarNode('datatable_entity_parameter')->defaultValue('OpenOrchestra\ApiBundle\Facade\DatatableEntityParameterFacade')->end()
                    ->scalarNode('datatable_column_parameter')->defaultValue('OpenOrchestra\ApiBundle\Facade\DatatableColumnParameterFacade')->end()
