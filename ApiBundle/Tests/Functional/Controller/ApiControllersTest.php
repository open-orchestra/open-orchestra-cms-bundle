...
class ApiControllersTest extends AbstractControllerTest
{
    ...
    public function provideApiUrl()
    {
        return array(
            ...
            array('/api/node/list/not-published-by-contributor'),
            array('/api/node/list/by-contributor'),
            array('/api/content'),
            array('/api/content/list/by-contributor'),
            array('/api/content/list/not-published-by-contributor'),
